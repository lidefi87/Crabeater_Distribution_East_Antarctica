...
We can see these models differ significantly, but since multicollinearity has a negative effect on GAM predictive ability, we will use the `significant_only_no_SIC` to predict crabeater distribution.  
