...
#Add title
title <- ggdraw()+
  draw_label("Mean crabeater seal distribution (ACCESS-OM2-01 - simplified)",
...
#Add title
title <- ggdraw()+
  draw_label("Mean crabeater seal distribution (ACCESS-OM2-01 - all variables)",
             fontface = "bold", hjust = 0.5)+
  theme(plot.margin = margin(0, 0, 0, 0))
...
```{r}
#Prediction monthly crabeater seal distribution
mean_pred_obs <- mean_model_baked %>% 
