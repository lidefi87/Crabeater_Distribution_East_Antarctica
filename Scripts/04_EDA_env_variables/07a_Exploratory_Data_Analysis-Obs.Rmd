...
```{r data}
crab_ind <- read_csv("../Cleaned_Data/Env_obs/unique_crabeater_obs_all_env.csv") %>%  
  ...
  bind_rows(read_csv("../Cleaned_Data/Env_obs/unique_background_5x_obs_all_env.csv"))
...
```{r save_data}
crab_ind %>%
  write_csv("../Cleaned_Data/Env_obs/Obs_BG_5x_Indian_weaning_LowVIF.csv")
```
